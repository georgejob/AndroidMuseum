...
public class Amnh extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amnh);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Ticket Price Calculator");

        Toast.makeText(Amnh.this, "Maximum of 5 tickets for each!", Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(getIntent().ACTION_VIEW, Uri.parse("https://www.amnh.org/")));
    }

    public void calculatePrice() {
        int adultTotal = Integer.valueOf(spin.getSelectedItem().toString()) * 23;
