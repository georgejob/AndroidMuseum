...
public class Metr extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Metr.this, "Maximum of 5 tickets for each!", Toast.LENGTH_SHORT).show();
    ...
    {
        startActivity(new Intent(getIntent().ACTION_VIEW, Uri.parse("https://www.metmuseum.org/")));
    }

    public void calculatePrice() {
        int adultTotal = Integer.valueOf(spin.getSelectedItem().toString()) * 25;
        int seniorTotal = Integer.valueOf(spin2.getSelectedItem().toString()) * 17;
        int studentTotal = Integer.valueOf(spin3.getSelectedItem().toString()) * 12;
